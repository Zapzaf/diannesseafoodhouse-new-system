...
@section('content')
    <x-page-header title="Add Account" subtitle="Register a new debit/expense or credit/liability account" icon="plus-circle">
            ...
            <div class="card-body p-0">
                <form action="{{ route('chart-of-accounts.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="e.g. Accounts Payable - Pacific Fresh Catch Trading" required>
                        @error('name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Code</label>
                        <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}" placeholder="Optional">
